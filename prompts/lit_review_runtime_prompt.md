...
Copy everything between the triple backticks and paste it into Claude Code to start a new review.
...
- llm_backend: <REPLACE: claude | openrouter_free | gemini_flash | qwen3_coder_free | nemotron_ultra_free | nemotron_super_free>
